-- 071 — Fulltext bez diakritiky (beh → běh)
-- search_vector i dotaz prochází unaccent, aby prefix match fungoval bez háčků/čárek.
...
COMMENT ON FUNCTION public.immutable_unaccent(text) IS
  'IMMUTABLE obal nad extensions.unaccent — pro GENERATED search_vector a search_posts.';
...
BEGIN
  ...
  -- Bez diakritiky + prefix: „beh“ najde „běh“, „tri“ najde „Tričko“
  SELECT string_agg(
