-- Homepage výpis — veřejné inzeráty v okolí / nedávné
...
GRANT EXECUTE ON FUNCTION public.get_nearby_posts TO anon, authenticated;
GRANT EXECUTE ON FUNCTION public.get_recent_posts TO anon, authenticated;
