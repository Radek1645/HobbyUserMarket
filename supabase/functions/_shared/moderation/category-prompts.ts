...
const CATEGORY_AI_PROMPTS: Record<string, string> = {
  ...
  "zbozi/auta-moto": "Úvod + Parametry (rok, nájezd, motorizace, STK, datum poslední servisní prohlídky, výbava, stav). Chybí-li datum poslední servisní prohlídky, zeptej se (paramLabel: „Poslední servis“). Na cenu se neptej, pokud je ve formuláři — cenu dej do úvodu. Dotazník jen na chybějící údaje.",
