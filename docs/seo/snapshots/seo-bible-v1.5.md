...
> **Verzování:** viz [`README.md`](./README.md) · historie [`CHANGELOG.md`](./CHANGELOG.md) · snapshot [`snapshots/seo-bible-v1.5.md`](./snapshots/seo-bible-v1.5.md)  
...
- **Hard cap storage/SERP:** 160 znaků — delší text platforma **ořízne** (`clampListingMetaDescription` při validaci + Edge normalize). Krátký text může doplnit CTA pad (`ensureMetaDescriptionLength`).
- **Priorita vět:** produkt + lokalita + cena → benefit / use-case → CTA. Preferuj oznamovací věty před „Hledáte…?“.
- **Při clampu:** nejdřív **vyhoď CTA větu**, teprve pak větný / slovný řez — produkt a lokalita mají zůstat.
...
- Příklad (~155 znaků): *Baterie Li-ion Samsung 48V 17Ah ve Slavkově u Brna za 4 000 Kč. Spolehlivý akumulátor na elektrokolo. Detaily a kontakt na platformě.*
...
**META_DESCRIPTION:** `Baterie Li-ion Samsung 48V 17Ah ve Slavkově u Brna za 4 000 Kč. Spolehlivý akumulátor na elektrokolo. Detaily a kontakt na platformě.`  
