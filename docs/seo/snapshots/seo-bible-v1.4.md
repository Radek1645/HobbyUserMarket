...
> **Verzování:** viz [`README.md`](./README.md) · historie [`CHANGELOG.md`](./CHANGELOG.md) · snapshot [`snapshots/seo-bible-v1.4.md`](./snapshots/seo-bible-v1.4.md)  
...
- **Hlavní fotka:** věcný `image_alt` (klíčové slovo + atribut + lokalita); max 125 po clamp (přetečení se ořízne, nezamítne).
