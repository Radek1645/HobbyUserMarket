...
Vaše údaje (e-mail, přezdívka) potřebujeme k provozu účtu a inzerce. Občanské jméno ani telefon v profilu nevyžadujeme. Bez registrace můžete připravit koncept inzerátu v prohlížeči; zveřejnění až po založení účtu. Při nákupu balíčku zpracujeme údaje o platbě (e-mail účtu, částka, variabilní symbol). IP u poptávek anonymizujeme do 7 dnů. Neaktivní účty bez přihlášení déle než 90 dní a bez aktivního inzerátu automaticky anonymizujeme (s předchozím upozorněním). Citlivé údaje nikomu neprodáváme.

---

## 1. Kdo zpracovává údaje a proč

Správcem osobních údajů je Provozovatel platformy zaPikolou.cz. Zpracováváme údaje v rozsahu nezbytném pro provoz účtu, publikaci inzerátů, přípravu konceptu inzerátu před registrací, nákup placených inzertních balíčků, bezpečnost komunity a — s vaším souhlasem — pro marketing a analytiku.
...
| Resend | transakční e-maily (notifikace, poptávky, potvrzení platby) | EU — Ireland (`eu-west-1`), doména `zapikolou.cz` (ověřeno v Resend dashboardu 2026-07-19); účetní/provozní údaje poskytovatele mohou být mimo EHP — DPA a SCC dle smlouvy s Resend |
...
Banka, u které Provozovatel přijímá platby za inzertní balíčky, zpracovává platební údaje jako **samostatný správce** podle vlastních podmínek — není zpracovatelem Provozovatele.
...
**7 dní před anonymizací** zašleme upozornění na e-mail uvedený u účtu. Přihlášení během této lhůty proces anonymizace zastaví. Po anonymizaci jsou identifikační údaje v profilu nahrazeny a autentizační účet je odstraněn — viz [VOP](/vop) §6. Účetní a daňové doklady k zaplaceným balíčkům se v rozsahu zákonné povinnosti uchovávají i po anonymizaci účtu (viz §2).
