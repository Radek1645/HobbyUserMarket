...
> **Technická poznámka (interní):** Checklist P33 — Supabase `eu-west-1`, Vercel `dub1`, Resend sending `eu-west-1` (Ireland, zapikolou.cz Verified 2026-07-19). AI mimo EHP + DPA/SCC v §5.1. Zbývá: podpis Resend DPA; revize právníkem. Detail: docs/TO-DO_Fable.md P33.
