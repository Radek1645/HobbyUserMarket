...
**Inzertní služba** = právo **zveřejnit** inzerát na platformě (po absolvování moderace). Počítá se **lifetime** — každá první publikace spotřebuje 1 kredit; smazání nebo archivace inzerátu kredit **nevrací**. Nový účet dostane startovní balíček zdarma; další kredity lze dokoupit dle ceníku níže.

---

## 1. Co je inzertní služba
...
- **Placená inzertní služba** — kredit z dokoupeného balíčku; cena a rozsah jsou uvedeny v ceníku níže.

---

## 2. Lifetime kredity (jak se limit počítá)
...
## 3. Aktuální balíčky a ceník

Provozovatel je oprávněn tento ceník **kdykoli upravit** s účinností od zveřejnění na této stránce — bez nutnosti současné změny [VOP](/vop). U **placených** balíčků již zakoupených kreditů se změna ceníku nedotýká již přidělených kreditů.
...
## 4. Pořízení dalších balíčků

Online platba bude dostupná po spuštění platební brány. Do té doby:

- **Kontakt:** [e-mail provozovatele] — uveďte e-mail účtu a požadovaný balíček.
- Po připsání kreditu obdržíte potvrzení e-mailem.

U **placené** inzertní služby platí reklamační práva dle [VOP §2](/vop) (výhradně u technických výpadků placených služeb delších než 5 hodin).
