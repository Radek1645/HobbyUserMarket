...
### 2.3 Inzertní služby a balíčky

**Inzertní službou** se rozumí plnění Provozovatele spočívající v umožnění zveřejnění inzerátu na platformě (včetně startovního bezplatného rozsahu a dokoupených kreditů).

Konkrétní **balíčky, ceník, počet publikací a pravidla spotřeby kreditů** (lifetime model) jsou vedeny mimo tento dokument na stránce [Balíčky inzerce](/balicky-inzerce). Provozovatel je oprávněn ceník a parametry balíčků aktualizovat. Uživatelům inzerujícím jako Podnikatelé musí být každá změna ceníku nebo parametrů balíčků, která pro ně znamená zhoršení podmínek, oznámena e-mailem nejméně **15 dní** před plánovanou účinností této změny. Pokud Podnikatel v této lhůtě s novými podmínkami nesouhlasí, má právo smlouvu vypovědět a inzerci bez sankcí ukončit. U ostatních uživatelů platí zveřejnění na uvedeném odkazu; již přidělené kredity zůstávají v platnosti.
...
| [Balíčky inzerce](/balicky-inzerce) | Ceník, limity publikací, inzertní služby |
...
Ukončením nebo podstatným omezením provozu zaniká možnost zveřejnění a prohlížení inzerátů. U **bezplatného** startovního rozsahu nevzniká uživateli nárok na náhradu, obnovu kreditů ani jiné peněžité plnění. U **placených** balíčků se případné vypořádání řídí [Balíčky inzerce](/balicky-inzerce) a zákonnými právy spotřebitele.
