...
type ListingImageGalleryProps = {
  ...
  /** Overlay přes roh úvodní fotky (sdílení). Sourozenec zoom tlačítka, ne vnořený button. */
  shareOverlay?: ReactNode;
};
      ...
      <div className="space-y-3">
        <div className="relative rounded-2xl border border-gray-200 bg-gray-100">
          <button
            ...
            className="group relative flex w-full min-h-[240px] max-h-[min(70vh,520px)] cursor-zoom-in items-center justify-center overflow-hidden rounded-2xl"
