      ...
      listingNeedsModeration(
        {
          ...
          listingDurationDays: params.listingDurationDays,
          showContactEmail: params.showContactEmail,
          showContactPhone: params.showContactPhone,
          contactPhone: params.contactPhone,
          jobCvRequired: params.jobCvRequired,
        },
